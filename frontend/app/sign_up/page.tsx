...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Successful signup → Sign In page
      router.push("/sign_in");
    } catch (err: any) {
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#020617] text-slate-100">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          ...
          >
            <motion.div
              className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/10"
              animate={{
                boxShadow: [
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-500">
                Start exploring terrain intelligence.
              </p>
            </motion.div>
              ...
              >
                ...
                <motion.div className="relative" whileFocus={{ scale: 1.01 }}>
                  ...
                  <motion.input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/[0.035] py-3.5 pl-11 pr-4 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-cyan-400/40"
                  />
                </motion.div>
              </motion.div>
